...
public abstract class TestInvokeAWSGatewayApiCommon {
    ...
    public void setupEndpointAndRegion() {
        runner.setProperty(InvokeAWSGatewayApi.AWS_GATEWAY_API_REGION, "us-east-1");
        runner.setProperty(InvokeAWSGatewayApi.AWS_API_KEY, "abcd");
        runner.setProperty(InvokeAWSGatewayApi.AWS_GATEWAY_API_ENDPOINT, url);
    }
    ...
    public void test200() throws Exception {
        ...
        runner.setProperty(InvokeAWSGatewayApi.RESOURCE_NAME, "/status/200");
    ...
    public void test500() throws Exception {
        ...
        runner.setProperty(InvokeAWSGatewayApi.RESOURCE_NAME, "/status/500");
    ...
    public void test300() throws Exception {
        ...
        runner.setProperty(InvokeAWSGatewayApi.RESOURCE_NAME, "/status/302");
    ...
    public void test304() throws Exception {
        ...
        runner.setProperty(InvokeAWSGatewayApi.RESOURCE_NAME, "/status/304");
    ...
    public void test400() throws Exception {
        ...
        runner.setProperty(InvokeAWSGatewayApi.RESOURCE_NAME, "/status/400");
    ...
    public void test412() throws Exception {
        ...
        runner.setProperty(InvokeAWSGatewayApi.RESOURCE_NAME, "/status/412");
    ...
    public void testPost() throws Exception {
        ...
        runner.setProperty(InvokeAWSGatewayApi.RESOURCE_NAME, "/post");
    ...
    public void testPostWithEmptyBodySet() throws Exception {
        ...
        public void testPatch() throws Exception {
            ...
            runner.setProperty(InvokeAWSGatewayApi.RESOURCE_NAME, "/patch");
    ...
    public void testConnectFailBadPort() throws Exception {
        ...
        runner.setProperty(InvokeAWSGatewayApi.AWS_GATEWAY_API_ENDPOINT, badurlport);
        runner.setProperty(InvokeAWSGatewayApi.RESOURCE_NAME, "/doesnotExist");
        createFlowFiles(runner);
    ...
    public void testConnectFailBadHost() throws Exception {
        ...
        runner.setProperty(InvokeAWSGatewayApi.AWS_GATEWAY_API_ENDPOINT, badurlhost);
        runner.setProperty(InvokeAWSGatewayApi.RESOURCE_NAME, "/doesnotExist");
        createFlowFiles(runner);
    ...
    public void testProxy() throws Exception {
        ...
        runner.setProperty(InvokeAWSGatewayApi.AWS_GATEWAY_API_ENDPOINT, "http://nifi.apache.org/");
        runner.setProperty(InvokeAWSGatewayApi.RESOURCE_NAME, "/status/200");
