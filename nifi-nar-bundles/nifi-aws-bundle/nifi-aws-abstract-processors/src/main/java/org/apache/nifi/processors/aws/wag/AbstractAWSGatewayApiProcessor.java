...
public abstract class AbstractAWSGatewayApiProcessor extends
    ...
    public static final PropertyDescriptor PROP_METHOD = new PropertyDescriptor.Builder()
        ...
        .required(true).defaultValue("GET").expressionLanguageSupported(true).addValidator(
            StandardValidators
                .createAttributeExpressionLanguageValidator(AttributeExpression.ResultType.STRING))
        .build();

    public static final PropertyDescriptor AWS_API_KEY = new PropertyDescriptor.Builder()
        .name("Amazon Gateway Api Key").description("The API Key").required(false)
        .addValidator(StandardValidators.NON_EMPTY_VALIDATOR).build();

    public static final PropertyDescriptor AWS_GATEWAY_API_ENDPOINT = new PropertyDescriptor.Builder()
        .name("Amazon Gateway Api Endpoint").description("The Api Endpoint").required(true)
    ...
    public static final PropertyDescriptor AWS_GATEWAY_API_REGION = new PropertyDescriptor.Builder()
        .name("Amazon Gateway Api Region").required(true)
    ...
    public static final PropertyDescriptor RESOURCE_NAME = new PropertyDescriptor.Builder()
        .name("Amazon Gateway Api ResourceName").description("The Name of the Gateway API Resource")
    ...
    public static final PropertyDescriptor PROP_QUERY_PARAMS = new PropertyDescriptor.Builder()
        ...
        .required(false).expressionLanguageSupported(true).addValidator(StandardValidators
    ...
    public static final PropertyDescriptor PROP_ATTRIBUTES_TO_SEND = new PropertyDescriptor.Builder()
        .name("Attributes to Send").description(
            "Regular expression that defines which attributes to send as HTTP headers in the request. "
                ...
                + "language will be the header value.").required(false)
    ...
    public static final PropertyDescriptor PROP_PUT_OUTPUT_IN_ATTRIBUTE = new PropertyDescriptor.Builder()
        .name("Put Response Body In Attribute").description(
        ...
        .addValidator(StandardValidators.createAttributeExpressionLanguageValidator(
            AttributeExpression.ResultType.STRING)).expressionLanguageSupported(true).build();

    public static final PropertyDescriptor PROP_OUTPUT_RESPONSE_REGARDLESS = new PropertyDescriptor.Builder()
        .name("Always Output Response").description(
    ...
    public static final PropertyDescriptor PROP_PENALIZE_NO_RETRY = new PropertyDescriptor.Builder()
        .name("Penalize on \"No Retry\"").description(
    ...
    public static final PropertyDescriptor PROP_PROXY_PASSWORD = new PropertyDescriptor.Builder()
        ...
        .description("Password to set when authenticating against proxy").required(false)
    ...
    public static final PropertyDescriptor PROP_PUT_ATTRIBUTE_MAX_LENGTH = new PropertyDescriptor.Builder()
        .name("Max Length To Put In Attribute").description(
    ...
    public static final PropertyDescriptor PROP_SEND_BODY = new PropertyDescriptor.Builder()
        .name("send-message-body").displayName("Send Message Body").description(
    ...
    public static final PropertyDescriptor PROP_ADD_HEADERS_TO_REQUEST = new PropertyDescriptor.Builder()
        .name("Add Response Headers to Request").description(
    ...
    public static final PropertyDescriptor PROP_CONNECT_TIMEOUT = new PropertyDescriptor.Builder()
        ...
        .required(false).defaultValue("10 secs")
    ...
    public static final PropertyDescriptor PROP_READ_TIMEOUT = new PropertyDescriptor.Builder()
        .name("Read Timeout").description("Max wait time for response from remote service.")
        .required(false).defaultValue("50 secs")
        .addValidator(StandardValidators.TIME_PERIOD_VALIDATOR).build();
    ...
    protected GenericApiGatewayClient createClient(ProcessContext context,
        ...
        GenericApiGatewayClientBuilder builder = new GenericApiGatewayClientBuilder()
            ...
            .withEndpoint(context.getProperty(AWS_GATEWAY_API_ENDPOINT).getValue()).withRegion(
                Region.getRegion(
                    Regions.fromName(context.getProperty(AWS_GATEWAY_API_REGION).getValue())));
